...
if [[ $install == true ]]; then
  bash <(curl -s https://raw.githubusercontent.com/FonicsScriptsDE/FiveMNewInstall2025/blob/main/InstallTwo.sh) $runtime_link
else
  bash <(curl -s https://raw.githubusercontent.com/FonicsScriptsDE/FiveMNewInstall2025/refs/heads/main/update.sh) $runtime_link
fi